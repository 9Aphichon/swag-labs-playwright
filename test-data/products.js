export const sauceLabsBackpack = {
...
export const sauceLabsBikeLight = {
...
export const sauceLabsBoltTShirt = {
    ...
    price: "$15.99",
    imgSrc: "/static/media/bolt-shirt-1200x1500.c2599ac5.jpg"
};
export const sauceLabsFleeceJacket = {
...
export const sauceLabsOnesie = {
    ...
    price: "$7.99",
    imgSrc: "/static/media/red-onesie-1200x1500.2ec615b2.jpg"
};
export const testAllTheThingsTShirtRed = {
    ...
    price: "$15.99",
    imgSrc: "/static/media/red-tatt-1200x1500.30dadef4.jpg"
};